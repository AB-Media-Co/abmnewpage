...
export const landingContent = {
    ...
    bonuses: [
        { title: 'On-Page SEO Mastery', img: 'bonus1.png', desc: 'The video program to master On-Page SEO' },
        { title: 'SEO Vault', img: 'bonus2.png', desc: 'Free training process of scaling Shopify stores' },
        { title: 'Themes for SEO', img: 'bonus3.png', desc: 'The best Shopify themes for SEO' },
        { title: 'Community Access', img: 'bonus4.png', desc: 'Included people on a similar mission as you' }
    ],
        ...
        <div className="min-h-screen bg-slate-900 text-white">
            <div className='max-w-6xl mx-auto'>
                ...
                <section className="grid lg:grid-cols-2 gap-8 px-4 max-w-6xl mx-auto mb-16">
                    ...
                    <div className='flex flex-col gap-6'>
                        <div className="space-y-4">
                            <iframe
                                src={`https://fast.wistia.net/embed/iframe/5u9qspiy4r?autoPlay=true`}
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="space-y-6 text-lg text-gray-300 text-left max-w-2xl mx-auto">
                    <p>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                                ...
                                <div className="relative max-w-xl mx-auto">
                                    ...
                                    <video className="w-full h-full rounded-lg" controls>
                                        <source src="/videos/jesse.mp4" type="video/mp4" />
                                        Your browser does not support the video tag.
                                    </video>
                                    </div>
                                </div>
                ...
                <section className="bg-slate-800 py-1 px-4">
                        <div className="max-w-3xl mx-auto text-left space-y-6">
               ...
               <section className="bg-slate-800 py-1 px-4">
                ...
                <div className="max-w-4xl mx-auto text-left space-y-6">
                    ...
                    <section className="bg-slate-800 py-1 px-4">
                        ...
                        {/* next sect */}
                    <section className="bg-slate-800  px-4">
                        <div className="max-w-4xl mx-auto text-left space-y-6">
                    ...
                    <section className="bg-slate-800 py-1 px-4">
                        ...
                        {/* discover in seo checklist */}
                    <section className="bg-slate-800 py-2 px-4">
                        <div className="max-w-4xl mx-auto text-left space-y-8">
                            ...
                            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/geFyhGMcICfV9Fw6HQBK/media/f2673743-8694-48ff-957b-f8826fdacd53.png" alt="Example Google Listing" className="rounded-lg border border-gray-400" />
                            </div>
                            ...
                            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/geFyhGMcICfV9Fw6HQBK/media/6d67e35b-aea1-4807-9270-796901f5ce39.jpg" alt="Bing Analytics Dashboard" className="rounded-lg border border-gray-400" />
                            </div>
                            ...
                            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/geFyhGMcICfV9Fw6HQBK/media/f4a250b3-6b36-4745-b51d-c74d99e05e1d.png" alt="Silo Content Structure" className="rounded-lg border border-gray-400" />
                            </div>
                            ...
                            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/geFyhGMcICfV9Fw6HQBK/media/b9f469ee-7ad1-4a73-b9a0-214281f82b39.png" alt="Affiliate Programs SERP" className="rounded-lg border border-gray-400" />
                            </div>
                            ...
                            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/geFyhGMcICfV9Fw6HQBK/media/8f7d7934-defb-4b38-8c4a-99810ec476df.png" alt="YouTube Video Results" className="rounded-lg border border-gray-400" />
                            </div>
                            ...
                            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/geFyhGMcICfV9Fw6HQBK/media/56be2c1a-b913-46d8-8f7a-780c23908fe2.jpeg" alt="Organic Traffic Protection" className="rounded-lg border border-gray-400" />
                            </div>
                            ...
                            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/geFyhGMcICfV9Fw6HQBK/media/8ef76219-7c6c-486d-aa5d-cd665168f1d7.jpeg" alt="International SEO Chart" className="rounded-lg border border-gray-400" />
                            </div>
                    ...
                    <section className="bg-slate-900 py-1 px-4 ">
                        <div className="max-w-4xl mx-auto text-white space-y-8">
                ...
                <section className="bg-slate-800 py-16 px-4">
                    ...
                    <button className="bg-[var(--primary)] hover:bg-[var(--dark-primary)] text-white font-semibold py-4 px-8 rounded-lg transition">Get The Checklist Now</button>
                </section>
                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    ...
                    <div className="bg-slate-800 text-white p-4 rounded shadow-md">
                        ...
                        <img src="/path-to/shopify-checklist.png" alt="Shopify SEO Checklist" className="w-24" />
                        <p className="text-sm">
                    ...
                    <div className="bg-slate-800 text-white p-4 rounded shadow-md">
                        ...
                        <div className="flex items-start gap-4">
                        <img src="/path-to/onpage-seo-guide.png" alt="On-Page SEO Mastery" className="w-24" />
                        <p className="text-sm">
                    ...
                    <div className="bg-slate-800 text-white p-4 rounded shadow-md">
                        ...
                        <div className="flex items-start gap-4">
                        <img src="/path-to/seo-vault.png" alt="SEO Vault" className="w-24" />
                        <p className="text-sm">
                    ...
                    <div className="bg-slate-800 text-white p-4 rounded shadow-md">
                        ...
                        <div className="flex items-start gap-4">
                        <img src="/path-to/shopify-themes.png" alt="Shopify Themes for SEO" className="w-24" />
                        <p className="text-sm">
                    ...
                    <div className="col-span-1 md:col-span-2 bg-slate-800 text-white p-4 rounded shadow-md">
                        ...
                        <div className="flex items-start gap-4">
                        <img src="/path-to/seo-community.png" alt="SEO Community" className="w-24" />
                        <p className="text-sm">
